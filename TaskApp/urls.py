...
urlpatterns = [
    ...
    path('submit_answer/<int:quiz_id>/', submit_answer, name='submit_answer'),
    path('update_answer/<int:answer_id>/', update_answer, name='update_answer'),
    path('thank-you/', thank_you_page, name='thank_you_page'),
    path('all_quizzes/', all_quizzes, name='all_quizzes'),
    path('view_q/<int:quiz_id>/', view_quiz, name='view_q'),
